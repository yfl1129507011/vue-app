<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span v-if="catView.category1Name">{{ catView.category1Name }}</span>
        <span v-if="catView.category2Name">{{ catView.category2Name }}</span>
        <span v-if="catView.category3Name">{{ catView.category3Name }}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        <!-- 左侧放大镜区域 -->
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd @click="changeAttrActive(spuSaleAttrValue, spuSaleAttr.spuSaleAttrValueList)" v-for="spuSaleAttrValue in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id"
...
export default {
  ...
  computed: {
    ...mapGetters(['catView', 'skuInfo', 'spuSaleAttrList'])
  },
  methods: {
    changeAttrActive(saleAttrVal, list) {
      list.forEach(item => {
        item.isChecked = 0
      })
